...
class Feedback:
    def __init__(self, master):
        ...
        ttk.Label(self.frame_header, wraplength=280,
                  text=(
                  "We're glad you chose to use the virus scanner by Elad and Nadav. Please Choose a file from your"
    ...
    def submit(self):
        ...
        # We check if the file is URL or a file from the PC , and then activating the right function
        ...
        # If the file is valid we can start the scanning
        if(self.procced ==1):
            self.scan_viruses()
            self.clear()
            self.show_results()
